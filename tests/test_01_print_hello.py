...
from src.main import print_hello # gets print_hello from .../Lab-02-VScode_and_Github/Lab-02-Solution/src
...
class Testprinthello(unittest.TestCase):
    ...
    def test_print_hello(self):
        ...
        # Expected output
        expected_output = "This is my first test. It should print out a message here:  Hello World!"
...
if __name__ == '__main__': # run this if its being run directly ie the main or else dont run this
    ...
    suite = loader.loadTestsFromTestCase(Testprinthello)
